...
•Installing and connecting System Center App Controller to the Service Provider Foundation
...
•Publicly accessible •Service Management Tenant Site
•Service Management Tenant Public API

•Secure internal access •Service Management Admin Site
...
Windows Integrated Authentication Add Computer Account
...
Windows Integrated Auth distributed installation
...
Local User for SPF Registration
...
Add User for SPF Registration to Local Groups
...
Features Setup Internal Access

After the configuration wizard is finished and the Admin Site is opened the Service Management Portal will present the error that some not all components are installed.
...
Database Server Setup distributed installation

When the values are validated you can complete the configuration.

Features Setup Public Access
...
Local Administrator login on 30091
