...
You can find a full deployable example template design, with both sharing state through individual parameters as sharing state through an object my GitHub repository here:
